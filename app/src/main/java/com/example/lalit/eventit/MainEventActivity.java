...
public class MainEventActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.llMain2,new FrgReplaceCreateEvent()).commit();
    ...
    public void changeFragment(View view) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.llMain2,new FrgCreateEvent()).commit();
    }
}
